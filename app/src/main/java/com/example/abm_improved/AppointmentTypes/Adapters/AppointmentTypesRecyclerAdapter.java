package com.example.abm_improved.AppointmentTypes.Adapters;
 ...
 */
public class AppointmentTypesRecyclerAdapter extends RecyclerView.Adapter<AppointmentTypesRecyclerAdapter.AppointmentTypeViewHolder> {
    ...
    public AppointmentTypesRecyclerAdapter(ArrayList<AppointmentType> appointmentTypes) {
